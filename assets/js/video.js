$(document).ready(function() {
    ...
    if (screenWidth > 800) {
        $("#video").html('<video ' +
            ...
            '<a class="center-align btn btn-primary alfa-electrique" href="https://www.helloasso.com/associations/association-lutte-forme-d-aigrefeuille-alfa/adhesions/adhesions-saison-2021-2022">Je m\'inscris !</a>' +
            '</div>' +
            '</div>');
